...
proc create_root_design { parentCell } {
  ...
  set OUT2 [ create_bd_port -dir O OUT2 ]
  ...
  connect_bd_net -net X_1 [get_bd_ports X] [get_bd_pins xup_and2_0/b] [get_bd_pins xup_xor2_0/a]
  connect_bd_net -net Y_1 [get_bd_ports Y] [get_bd_pins xup_and2_0/a] [get_bd_pins xup_xor2_0/b]
  connect_bd_net -net Z_1 [get_bd_ports Z] [get_bd_pins xup_and2_1/b] [get_bd_pins xup_xor2_1/b]
  connect_bd_net -net xup_and2_0_y [get_bd_pins xup_and2_0/y] [get_bd_pins xup_inv_1/a]
  connect_bd_net -net xup_and2_1_y [get_bd_pins xup_and2_1/y] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net xup_and2_2_y [get_bd_pins xup_and2_2/y] [get_bd_pins xup_inv_2/a]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and2_2/b] [get_bd_pins xup_inv_0/y]
  connect_bd_net -net xup_inv_1_y [get_bd_pins xup_and2_2/a] [get_bd_pins xup_inv_1/y]
  connect_bd_net -net xup_inv_2_y [get_bd_ports OUT2] [get_bd_pins xup_inv_2/y]
  connect_bd_net -net xup_xor2_0_y [get_bd_pins xup_and2_1/a] [get_bd_pins xup_xor2_0/y] [get_bd_pins xup_xor2_1/a]
  connect_bd_net -net xup_xor2_1_y [get_bd_ports OUT1] [get_bd_pins xup_xor2_1/y]
