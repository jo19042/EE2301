...
################################################################
# This is a generated script based on design: One_Bit_Full_Adder
#
...
# source One_Bit_Full_Adder_script.tcl
...
set design_name One_Bit_Full_Adder
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Z_1 [get_bd_ports Z] [get_bd_pins xup_and2_1/b] [get_bd_pins xup_xor2_0/b]
  connect_bd_net -net a_0_1 [get_bd_ports X] [get_bd_pins xup_and2_0/a] [get_bd_pins xup_xor2_1/a]
  connect_bd_net -net b_0_1 [get_bd_ports Y] [get_bd_pins xup_and2_0/b] [get_bd_pins xup_xor2_1/b]
  ...
  connect_bd_net -net xup_or2_0_y [get_bd_ports OUT2] [get_bd_pins xup_or2_0/y]
  connect_bd_net -net xup_xor2_0_y [get_bd_ports OUT1] [get_bd_pins xup_xor2_0/y]
  connect_bd_net -net xup_xor2_1_y [get_bd_pins xup_and2_1/a] [get_bd_pins xup_xor2_0/a] [get_bd_pins xup_xor2_1/y]
